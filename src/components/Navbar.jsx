        ...
        <nav className="bg-blue-600 text-white py-4 shadow-md px-6 z-20">
            <div className="container mx-auto flex justify-between items-center">
                ...
                <div className="hidden md:flex md:space-x-4 z-10">
                    <Link to="/map" className="hover:bg-blue-500 px-3 py-2 rounded-md">
                        Map
                    </Link>
                    <Link to="/chat" className="hover:bg-blue-500 px-3 py-2 rounded-md">
                        Chat
                    </Link>
                    <Link to="/alerts" className="hover:bg-blue-500 px-3 py-2 rounded-md">
                        Alerts
                    </Link>
                    <Link to="/historical-weather" className="hover:bg-blue-500 px-3 py-2 rounded-md">
                        Historical Weather
                    </Link>
                </div>
            </div>
            ...
            <div className={`fixed top-0 right-0 w-64 h-full bg-blue-700 text-white shadow-lg transform transition-transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} z-50`}>
                ...
                <div className="flex flex-col space-y-4 p-4">
                    ...
                    <Link to="/chat" className="hover:bg-blue-500 px-3 py-2 rounded-md">Chat</Link>
                    <Link to="/alerts" className="hover:bg-blue-500 px-3 py-2 rounded-md">Alerts</Link>
                    <Link to="/historical-weather" className="hover:bg-blue-500 px-3 py-2 rounded-md">Historical Weather</Link>
                </div>
            </div>
        </nav>
    );
